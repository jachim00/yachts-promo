...
const fleet: Yacht[] = [
  {
    ...
    order: 1,
    spec: {
      deckLengthInflated: '5.8 m',
      beamInflated: '2.4 m',
      packedSize: '2 bags, 120 × 60 × 40 cm',
      totalWeight: '95 kg',
      capacity: 'up to 8 people / 1000 kg',
      workingPressure: '0.8–1.0 bar',
      inflationTime: '~20 min (electric pump)',
      material: 'Fusion drop-stitch, PVC 0.5 + 0.9 mm, Silvertex upholstery',
      drive: 'Silent electric motor / oars / own outboard',
      included: 'High-pressure pump, carry bags, repair kit, faux-teak deck',
    },
  ...
  },
  {
    ...
    order: 2,
    spec: {
      deckLengthInflated: '4.6 m',
      beamInflated: '2.0 m',
      packedSize: '1 bag, 110 × 55 × 35 cm',
      totalWeight: '62 kg',
      capacity: 'up to 4 people / 500 kg',
      workingPressure: '0.8–1.0 bar',
      inflationTime: '~12 min (electric pump)',
      material: 'Fusion drop-stitch, PVC 0.5 + 0.9 mm, Silvertex upholstery',
      drive: 'Silent electric motor / oars / own outboard',
      included: 'High-pressure pump, carry bag, repair kit, faux-teak deck',
    },
  ...
  },
  {
    ...
    order: 3,
    spec: {
      deckLengthInflated: '5.2 m',
      beamInflated: '2.2 m',
      packedSize: '2 bags, 115 × 58 × 38 cm',
      totalWeight: '80 kg',
      capacity: 'up to 6 people / 750 kg',
      workingPressure: '0.8–1.0 bar',
      inflationTime: '~16 min (electric pump)',
      material: 'Fusion drop-stitch, PVC 0.5 + 0.9 mm, Silvertex upholstery',
      drive: 'Silent electric motor',
      included: 'High-pressure pump, carry bags, repair kit, faux-teak deck',
    },
